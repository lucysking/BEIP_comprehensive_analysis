...
home <- "/Users/lking/Library/CloudStorage/Box-Box/lucy_king_files/Tulane/BEIP/comprehensive_analysis/"
...
forest_cogbio_p <-
  ...
  theme_beip +
  theme(
    axis.text.x = element_text(face = c('bold', 'plain', 'plain', 'plain', 'plain'))
  ) +
  labs(
    x = NULL,
